...
import { buildLimitsReport, LimitsConfig } from './limits.js';
import { buildStatsReport, StatsConfig } from './stats.js';
...
export default definePluginEntry({
  ...
  register(api) {
    const config = (api.pluginConfig ?? {}) as LimitsConfig & StatsConfig;
